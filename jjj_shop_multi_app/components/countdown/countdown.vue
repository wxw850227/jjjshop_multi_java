<template>
	...
	<view class="countdown">
		<template v-if="config.type == null">
			...
			<text v-if="status == 1">距开始：</text>
			<text v-if="status == 2">距结束：</text>
			<text class="box" :style="'background-color: '+backColor+';color:'+cut_color">{{ day }}</text>
			<text class="p-0-10" :style="'color:'+color">天</text>
			<text class="box" :style="'background-color: '+backColor+';color:'+cut_color">{{ hour }}</text>
			<text class="p-0-10" :style="'color:'+color">:</text>
			<text class="box" :style="'background-color: '+backColor+';color:'+cut_color">{{ minute }}</text>
			<text class="p-0-10" :style="'color:'+color">:</text>
			<text class="box" :style="'background-color: '+backColor+';color:'+cut_color">{{ second }}</text>
			<text class="p-0-10" :style="'color:'+color"></text>
		</template>
