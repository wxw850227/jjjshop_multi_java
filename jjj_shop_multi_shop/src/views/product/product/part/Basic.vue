<template>
  <div class="basic-setting-content pl16 pr16">
    ...
    <el-form-item label="商品编码："
      ><el-input v-model="form.model.productNo" class="max-w460"></el-input
    ></el-form-item>
    <el-form-item
      label="所属分类："
    ...
    <el-form-item
      v-if="form.model.isPreview == 1"
      label="预告开启购买时间"
      :rules="[{ required: true, message: '请选择开启购买时间' }]"
      prop="model.previewTime"
    >
      <el-date-picker
        v-model="form.model.previewTime"
        type="datetime"
    ...
    <el-form-item label="视频封面：">
      ...
      <div class="gray9">建议封面尺寸为750x750</div>
    </el-form-item>
    ...
    <el-form-item
      ...
      prop="form.model.virtualContent"
