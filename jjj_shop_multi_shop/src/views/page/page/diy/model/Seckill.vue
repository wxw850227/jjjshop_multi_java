  ...
  >
    <div class="diy-seckill">
      <div
        ...
        :style="'background: url(' + item.style.backgroundImage + ');'"
      >
        <div class="left d-s-c">
          ...
          <div class="datetime d-s-c">
            <div
              class="daybox hour"
              :style="{
                background: item.style.countdownBackColor,
                color: item.style.countdownColor,
              }"
            >
              12天
            </div>
        ...
        >
          ...
          <div class="product-info p-0-10">
            <div class="price f12 tc">
              ...
              <span v-if="item.style.show.linePrice" class="gray6 text-d-line"
                >¥233</span
              >
            </div>
          </div>
