  ...
  <div>
    ...
    <el-form size="small" :model="curItem" label-width="100px">
      ...
      <el-form-item label="底边距："
        ><el-slider v-model="curItem.style.bottom" show-input></el-slider
      ></el-form-item>
      <!--右边距-->
      <el-form-item label="右边距："
        ><el-slider v-model="curItem.style.right" show-input></el-slider
      ></el-form-item>
      <!--不透明度-->
      <el-form-item label="不透明度："
        ><el-slider v-model="curItem.style.opacity" show-input></el-slider
      ></el-form-item>
      <!--客服类型-->
