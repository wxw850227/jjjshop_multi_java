          ...
          <div class="d-a-c">
            ...
            >
              <div v-if="formData.type != 2">
                <img
                  class="nav_img"
                  v-img-url="index == 0 ? item.selectedIconPath : item.iconPath"
                  alt=""
                />
              </div>
              <div
      ...
      <el-form size="small" :model="formData" label-width="150px">
        ...
        <el-form-item label="背景颜色：">
          <div class="d-s-c">
            ...
            <el-button
              ...
              @click.stop="
                onEditorResetColor(formData, 'backgroundColor', '#ffffff')
              "
              >重置</el-button
            >
          </div>
        ...
        <el-form-item label="文字颜色：">
          <div class="d-s-c">
            ...
            <el-button
              style="margin-left: 10px"
              @click.stop="onEditorResetColor(formData, 'textColor', '#ffffff')"
              >重置</el-button
            >
          </div>
        </el-form-item>
        <el-form-item label="选中颜色：">
          <div class="d-s-c">
            <el-color-picker
              v-model="formData.textHoverColor"
            ></el-color-picker>
            <el-button
              style="margin-left: 10px"
              @click.stop="
                onEditorResetColor(formData, 'textHoverColor', '#ffffff')
              "
              >重置</el-button
            >
          </div>
                ...
                <div class="param-img-item ww100">
                  ...
                  <div class="d-a-c">
                    ...
                    <div class="icon">
                      已选中：
                      <img
                        v-img-url="element.selectedIconPath"
                        alt=""
                        @click="
                          onEditorSelectImage(element, 'selectedIconPath')
                        "
                      />
                    </div>
                  </div>
