...
let AuthApi = {
  ...
  roleAddInfo(data, errorback) {
    return request._get('/shop/auth/role/toAdd', data, errorback);
  },
  /*添加角色*/
  ...
  roleEditInfo(data, errorback) {
    return request._get('/shop/auth/role/toEdit', data, errorback);
  },
  /*修改角色*/
 ...
 /*修改管理员需要的数据*/
  userEditInfo(data, errorback) {
    return request._get('/shop/auth/user/toEdit', data, errorback);
  },
  /*修改管理员*/
