...
let MessageApi = {
  ...
  addMessage(data, errorback) {
    return request._postBody('/admin/message/add', data, errorback);
  },
  /*修改消息*/
  editMessage(data, errorback) {
    return request._postBody('/admin/message/edit', data, errorback);
  },
  /*删除消息*/
  ...
  saveField(data, errorback) {
    return request._postBody('/admin/message/saveField', data, errorback);
  },
}
