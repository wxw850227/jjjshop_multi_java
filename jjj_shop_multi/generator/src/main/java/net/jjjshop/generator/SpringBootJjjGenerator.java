...
public class SpringBootJjjGenerator {
    ...
    public static void main(String[] args) {
        ...
        // 设置表信息
        generatorProperties.addTable("jjjshop_agent_product","id");
        // 设置表前缀
        ...
        generatorProperties.getDataSourceConfig()
                ...
                .setUrl("jdbc:mysql://192.168.31.200:3307/jjj_shop_single_java?useUnicode=true&characterEncoding=UTF-8&useSSL=false");
