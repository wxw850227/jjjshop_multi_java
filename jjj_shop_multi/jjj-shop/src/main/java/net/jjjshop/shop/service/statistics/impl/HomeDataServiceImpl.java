...
public class HomeDataServiceImpl implements HomeDataService {
    ...
    public JSONObject getHomeData() throws ParseException {
        ...
        // 商品总量
        Integer productTotal = productDataUtils.getProductTotal(null);
        // 用户总量
        ...
        // 销售额(元)
        BigDecimal orderTotalPriceT = orderDataUtils.getOrderData(today, null, "order_total_price", null);
        BigDecimal orderTotalPriceY = orderDataUtils.getOrderData(yesterday, null, "order_total_price", null);

        // 支付订单数
        Integer orderTotalT = Integer.parseInt(orderDataUtils.getOrderData(today, null, "order_total", null).toString());
        Integer orderTotalY = Integer.parseInt(orderDataUtils.getOrderData(yesterday, null, "order_total", null).toString());
        ...
        // 最近七天日期订单交易数
        Integer orderTotal7 = Integer.parseInt(orderDataUtils.getOrderData(lately7days, today, "order_total", null).toString());
        //最近七天订单交易金额
        BigDecimal orderTotalPrice7 = orderDataUtils.getOrderData(lately7days, today, "order_total_price", null);
        //订单
        //待处理订单
        ...
        //库存告急商品
        Integer productStockTotal = productDataUtils.getProductStockTotal(null);
