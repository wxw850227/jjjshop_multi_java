...
public class JwtRealm extends AuthorizingRealm {
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principalCollection) {
        ...
        }else if(request.getRequestURI().startsWith("/api/supplier/")){
            // 获取登录用户角色权限信息
            LoginSupplierUserRedisVo loginSupplierUserRedisVo = supplierLoginRedisService.getLoginSupplierUserRedisVo(username);
            // 设置权限
            authorizationInfo.setStringPermissions(loginSupplierUserRedisVo.getPermissions());
        }
